...
[미니 프로젝트 계획서] 빅데이터(딥러닝), 홍길동

 파일 첨부하기

johnbann@empas.com

- 미니 프로젝트가 미완성일 경우, 앞으로의 방향성 작성하기

* MNIST GUI 툴 : 딥러닝 기법을 활용하면 정답률이 올라갈 것

* 직접 구현한 코드로 가져와서 필요하면 조절해서 쓸 수 있도록 코드 짠게 중요!



## 머신러닝 MNIST GUI Tool 수정

* 마우스로 숫자 그리는 부분을 좀 더 빠르게 쓸 수 있도록 수정
  * paper을 지우고 canvas 위에 바로 쓰도록 구현
