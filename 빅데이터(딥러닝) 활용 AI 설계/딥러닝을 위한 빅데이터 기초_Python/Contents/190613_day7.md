...
※ 교재 : Python for Data Analysis (파이썬 라이브러리를 활용한 데이터 분석)

## 도식화와 시각화

* p. 305 도식화와 시각화 참고
* python에서 numpy 및 pandas 설치
  * File - Setting - numpy / pandas / matplotlib 설치

![1560400197815](./190613_day7/1560400197815.png)



* 히스토그램
  * 영상의 명암 정도를 히스토그램으로 볼 수 있음
...
* 히스토그램으로 나타낸 결과
  * 그래프 분포를 보면 확대가 잘못된 것을 알 수 있음

![1560400730605](./190613_day7/1560400730605.png)



* 정상적인 히스토그램 분포

![1560400863219](./190613_day7/1560400863219.png)
...
![1560401611517](./190613_day7/1560401611517.png)



* End-In 탐색
  * 영상의 질이 좋아지기보다는 눈에서 확연히 보임
...
- 에지 검출 : 5개 이상
- (선택) LoG, DoG 에지 검출
- (선택) 다중 블러링 : 값을 입력받아 마스크의 크기를 가변적으로(3,5,7,9,.....)
...
comVisionMenu4.add_command(label='경계선 검출', command=sharpImage)
